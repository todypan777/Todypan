...
const MORE_TABS = [
  ...
  { id: 'almuerzos', label: 'Almuerzos', icon: (c) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <circle cx="11" cy="11" r="5.5" stroke={c} strokeWidth="1.6" fill="none"/>
      <circle cx="11" cy="11" r="2.2" stroke={c} strokeWidth="1.4" fill="none"/>
      <path d="M3 3 V8 Q3 9.5 4.5 9.5 V17" stroke={c} strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )},
  { id: 'desayunos', label: 'Desayunos', icon: (c) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M5 8 H15 V13 Q15 16 12 16 H8 Q5 16 5 13 Z" stroke={c} strokeWidth="1.6" fill="none" strokeLinejoin="round"/>
      <path d="M15 9 H17 Q18 9 18 10 V11 Q18 12 17 12 H15" stroke={c} strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M8 4 Q8 6 9 6 Q10 6 10 4" stroke={c} strokeWidth="1.4" fill="none" strokeLinecap="round"/>
      <path d="M11 4 Q11 6 12 6 Q13 6 13 4" stroke={c} strokeWidth="1.4" fill="none" strokeLinecap="round"/>
    </svg>
  )},
  { id: 'deudores', label: 'Deudores', icon: (c) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <circle cx="10" cy="7" r="3" stroke={c} strokeWidth="1.6" fill="none"/>
      <path d="M3 17 Q3 11 10 11 Q17 11 17 17" stroke={c} strokeWidth="1.6" fill="none"/>
      <circle cx="14" cy="14" r="3.5" stroke={c} strokeWidth="1.4" fill="none"/>
      <path d="M14 12.5 V14 L15 14.8" stroke={c} strokeWidth="1.4" strokeLinecap="round"/>
    </svg>
  )},
  { id: 'transferencias', label: 'Transferencias', icon: (c) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M4 7 H15 M12 4 L15 7 L12 10" stroke={c} strokeWidth="1.7" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M16 13 H5 M8 16 L5 13 L8 10" stroke={c} strokeWidth="1.7" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )},
  { id: 'tasks', label: 'Tareas', icon: (c) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <rect x="3" y="3" width="14" height="14" rx="3" stroke={c} strokeWidth="1.6" fill="none"/>
      <path d="M6.5 10 L9 12.5 L13.5 7.5" stroke={c} strokeWidth="1.7" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )},
